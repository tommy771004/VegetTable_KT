...
object PermissionManager {
     ...
     * 在 Activity 中請求位置權限
     */
    fun requestLocationPermission(activity: Activity, launcher: ActivityResultLauncher<Array<String>>) {
     ...
     * 在 Fragment 中請求位置權限
     */
    fun requestLocationPermission(fragment: Fragment, launcher: ActivityResultLauncher<Array<String>>) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            launcher.launch(arrayOf(
                Manifest.permission.ACCESS_FINE_LOCATION,
                Manifest.permission.ACCESS_COARSE_LOCATION
     ...
     */
    fun requestNotificationPermission(fragment: Fragment, launcher: ActivityResultLauncher<String>) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            launcher.launch(Manifest.permission.POST_NOTIFICATIONS)
        }
    }
